    ...
    <section className="panel">
      <div className="panel-heading">
        <div>
          ...
          <h2>Prepared sandbox actions</h2>
        </div>
        <span className="sandbox">NO REAL MONEY</span>
      </div>
      {query.isPending ? (
        <Loading />
      ) : query.error ? (
        ...
        <Empty title="No actions prepared">
          A plan is a proposal. Preparation, approval, and sandbox execution are
          separate steps.
        </Empty>
      ) : (
      ...
      <Notice>
        Execution requires every listed approval and a fresh state snapshot.
        Beneficiary changes invalidate authorization.
      </Notice>
    </section>
  );
}
