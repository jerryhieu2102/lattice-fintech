...
SCALE = {"EUR": 100, "USD": 100, "GBP": 100, "VND": 1}
BASE_RATE = {"EUR": 1, "USD": 0.90, "GBP": 1.17, "VND": 0.000036}
...
def optimize(state, verified_only=False):
    ...
    for f in funds:
        ...
        for o in obligations:
            if (
                ...
                or not o.get("beneficiary_verified")
            ):
                continue
            ...
            for r in routes:
                ...
                model.add((destination + 1) * rate.denominator >= principal * rate.numerator + 1)
    ...
    cost = round(
        sum(
            a["estimated_fee"] * BASE_RATE[a["source_currency"]] + a["estimated_fx_cost_eur"]
